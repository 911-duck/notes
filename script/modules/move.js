...
function move(event) {
    ...
    openRightBoardEditor(values.activeBlock);
    values.activeBlock.style.top = values.activeBlock.offsetTop - y + "px"
    values.activeBlock.style.left = values.activeBlock.offsetLeft - x + "px"
