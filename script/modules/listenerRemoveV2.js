...
function listenerRemoveV2(e) {
    ...
    values.OpenShortcuts = e.code;
                localStorage.removeItem('OpenShortcuts')
    localStorage.setItem('OpenShortcuts', values.OpenShortcuts)
}

export default listenerRemoveV2