...
function active(event) {
    ...
    values.activeBlock.style.border = "white solid 2px"
    document.querySelector(".open-note_screen").addEventListener("mousemove", move)
    values.activeBlock.addEventListener("mouseup", unactive)
    values.mouseXY.X = event.clientX
    values.mouseXY.Y = event.clientY
    console.log(values.activeBlock, values.mouseXY.X, values.mouseXY.Y)
}
