...
function listenerRemoveV7(e) {
    ELEMENTS.BUTTON_SHORTCUTSV7.innerText = `текущая настройка: 'навестись + ${e.key}'`;
    window.removeEventListener('keydown', listenerRemoveV7);
    values.DeleteHeader = e.code;
        localStorage.removeItem('DeleteHeader')
    localStorage.setItem('DeleteHeader', values.DeleteHeader)
}

export default listenerRemoveV7