...
export default ELEMENTS = {
    ...
    BOARD_EDITOR: document.querySelector(".right-board_editor"),
    DRAW_BOARD: document.querySelector(".draw_editor"),
    BG_EDITOR: document.querySelector(".right-board_editor-bg"),
    ...
    OPTION_BOARD_HEIGHT: document.querySelector(".right-board_height-input"),
    OPTION_BOARD_WIDTH: document.querySelector(".right-board_width-input"),
    OPTION_BOARD_Z_INDEX: document.querySelector(".right-board_z-index-input"),
    OPTION_ROTATE: document.querySelector(".right-board_rotate-input"),
    OPTION_BOARD_BORDER_RADIUS: document.querySelector(".right-board_border-radius-input"),
    OPTION_PICTURE_URL: document.querySelector(".picture-editor_option-backGround-url"),
    OPTION_BOARD_FONT: document.querySelector(".right-board_font-input"),
    OPTION_BOARD_X: document.querySelector(".right-board_x-input"),
    OPTION_BOARD_Y: document.querySelector(".right-board_y-input"),
    OPTION_DRAW_SECTIONS: document.querySelectorAll(".draw_section"),
    OPTION_BOARD_SHADOW: document.querySelector(".right-board_shadow-input"),
    OPTION_CHECK_BOX_BACKGROUND_COLOR: document.querySelector(".right-board_checkBox-background-color"),
    OPTION_BG_C: document.querySelector(".right-board_background-input-bg"),
    ...
    PENCIL: document.querySelector(".edit_draw"),
    ...
    BLACK_SCREEN_EDUCATION: document.querySelector(".info-background"),
    MESSAGE_WINDOW_EDUCATION: document.querySelector(".info-window"),
    MESSAGE_ARROW_EDUCATION: document.querySelector(".info-arrow"),
};